...
function Sprite(imageurl, width, height){
    ...
    this.spacePressedPosX = 0;
    this.spacePressedPosY = 0;
    ...
    this.checkKeys = function(keyNum){
        ...
        if(keysDown[Key_SPACE] == true){
            ...
            this.spacePressedPosX = this.x + (1/2 * this.width);    //Middle position of the sprite
            this.spacePressedPosY = this.y + (1/2 * this.height); 
        }
